...
// Runtime types generated with workerd@1.20250906.0 2025-09-09 experimental
...
interface DynamicWorkerLoader {
	get(id: string, configFactory: () => DynamicWorkerConfig): DynamicWorker;
}
...
interface DynamicWorkerConfig {
	...
	mainModule: string;
	modules: Record<string, string | { type?: string; source: string }>;
